...
<div>
    <div class="block flexCenter">
        ...
        <h2 class="sub-title">“A Leading Provider of Cutting Edge Rehabilitation Products”</h2>
    </div>
    ...
    <div class="box">
        <div class="columns is-variable is-8">
            <div class="level">
                <div class="column ">
                    <div class="content">
                        <h1 class="title">Building Your Therapy Business</h1>
                        <h2 class="title"></h2>
    ...
    <p><a href="https://vimeo.com/278169695">MR Cube Testimonials</a> from <a href="https://vimeo.com/user68925006">Anvil &amp; Hammer Agency</a> on <a href="https://vimeo.com">Vimeo</a>.</p>
        ...
        <div class="column">
            <div class="container">
                <div class="content">
                    <h1 class="title">Empowering and Equiping Your Therapists</h1>
                    <p>
    ...
    <div class="columns is-variable is-4">
        <div class="column">
            <div class="container">
                <div class="content">
                    <h1 class="title">Enhancing Patient Outcomes and Satisfaction</h1>
                    <p>
    ...
    <div class="content has-text-centered">
        <div class="columns">
            ...
            <div class="column">
                <div class="content">
                    <h2>Photography</h2>
<a href="https://unsplash.com/@timmossholder?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Tim Mossholder</a> on <a href="https://unsplash.com/s/photos/physical-therapy?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Unsplash</a></div>
            </div>
        </div>
    </div>
    </footer>
