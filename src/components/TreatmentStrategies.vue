...
<div>
     <el-main>
        <el-row :gutter="40">
            <el-col :span="24">
                <h1>Innovative Treatment Strategies</h1>
            </el-col>
        </el-row>
          ...
          <el-row :gutter="40">
            <el-col :span="12">
                ...
                <h2>We are Innovative Treatment Strategies</h2>
            ...
            <el-col :span="12">
                ...
                <h2>Building Your Therapy Business</h2>
                ...
                <h2>Empowering and Equiping Your Therapists</h2>
                ...
                <h2>Enhancing Patient Outcomes and Satisfaction</h2>
...
<p><a href="https://vimeo.com/278154734">Monitored Rehab Cube Product Demonstration</a> from <a href="https://vimeo.com/user68925006">Anvil &amp; Hammer Agency</a> on <a href="https://vimeo.com">Vimeo</a>.</p>
        ...
        <el-footer height="300px;">
          ...
          <div>
            <h2>Photography</h2>
            <ul>
              <li><span><a href="https://unsplash.com/@timmossholder?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Tim Mossholder</a> on <a href="https://unsplash.com/s/photos/physical-therapy?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Unsplash</a></span></li>
            </ul>
          </div>
