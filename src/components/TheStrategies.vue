        ...
        <div class="columns is-variable is-5">
            ...
            <div class="column">
                ...
                <img class="logoConstraint" src="../assets/imgs/logos/rehab.jpg"/>
                    <h1 class="subtitle">What is Rehab Strategies and what can we do for you?</h1>
                <div class="content">
                    <p>
        ...
        <div class="columns is-variable is-5">
            ...
            <div class="column">
                ...
                <img class="logoConstraint" src="../assets/imgs/logos/staffing.png"/>
                    <h1 class="subtitle">What is Staffing Strategies and what can we do for you?</h1>
                <div class="content">
                    <p>
        ...
        <div class="columns is-variable is-5">
            ...
            <div class="column">
                ...
                <img class="logoConstraint" src="../assets/imgs/logos/care.png"/>
                    <h1 class="subtitle">Brookside Care Strategies - A Familiar Place to Call Home</h1>
                <div class="content">
                    <p>
        ...
        <div class="columns is-variable is-5">
            ...
            <div class="column">
                ...
                <img class="logoConstraint" src="../assets/imgs/logos/ITSlogo.jpg"/>
                    <h1 class="subtitle">Innovative Treatment Strategies</h1>
                <div class="content">
                    <p>
